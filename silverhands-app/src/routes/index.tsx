          ...
          <div className="grid md:grid-cols-12 gap-8 items-end">
            <div className="md:col-span-7">
              ...
              <p className="mt-7 text-lg md:text-xl leading-relaxed max-w-xl" style={{ color: "#4A4630" }}>
                Cooking. Gardening. Tutoring. Craft passed down for generations. SilverHands
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div className="mt-12 grid md:grid-cols-12 gap-4 md:gap-5">
            ...
            <div className="md:col-span-5 grid grid-cols-2 gap-4 md:gap-5">
              {(
                [
                  { icon: ChefHat, label: "Homemade Food", caption: "Steam rising from a home-cooked thali", src: categoryImages.food },
            ...
            <Reveal>
              ...
              >
                ...
                <h3 className="font-display text-2xl md:text-3xl font-semibold mt-2">
                  {t("landing.buyerCardTitle")}
                </h3>
                <p className="mt-3 text-base" style={{ color: "#D9DCC0" }}>
                  Browse cooks, tutors, gardeners and craftspeople near you.
                </p>
          ...
          <Reveal delay={160}>
            <div className="mt-10 text-center">
              <Link
                ...
                style={{ backgroundColor: "#FFFDF5", color: "#2F312B" }}
              >
                {role === "buy" ? t("landing.continueAsBuyer") : t("landing.continueAsSeller")}
                <ArrowRight size={18} />
              </Link>
        ...
        <div className="mx-auto max-w-3xl px-6">
          <Reveal>
            <h2 className="font-display font-semibold text-4xl md:text-6xl leading-tight">
              {t("landing.closeHeadline1")}
              <br />
              {t("landing.closeHeadline2")}{" "}
              <span className="italic" style={{ color: "#C98C3A" }}>
                {t("landing.closeHeadline3")}
              </span>
            </h2>
            <a
              href="#entry"
