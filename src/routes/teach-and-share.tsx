...
export const Route = createFileRoute("/teach-and-share")({
  head: () => ({
    meta: [
      { title: "Teach & Share — ElderSkill" },
      {
        name: "description",
        content:
          "Add tutorials, set your available times and manage your upcoming ElderSkill sessions.",
      },
      { property: "og:title", content: "Teach & Share — ElderSkill" },
      {
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {isJoinable(b) && b.status === "CONFIRMED" && (
                      <Button asChild className="h-11 text-base">
                        <Link to="/meeting/$bookingId" params={{ bookingId: b.id }}>Join</Link>
                      </Button>
                    )}
                    <Button asChild variant="outline" className="h-11 text-base">
                      <Link to="/meeting/$bookingId" params={{ bookingId: b.id }}>View</Link>
                    </Button>
                    {b.status === "CONFIRMED" && (
                      <>
                        <Button
