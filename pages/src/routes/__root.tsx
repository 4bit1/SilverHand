...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SilverHands — Share a lifetime of skill" },
      {
        name: "description",
        content:
          "SilverHands connects experienced people with those who want to learn from them or hire them.",
      },
      { name: "author", content: "SilverHands" },
      { property: "og:title", content: "SilverHands — Share a lifetime of skill" },
      {
